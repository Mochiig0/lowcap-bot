...
INTERVAL_SECONDS="${LOWCAP_GECKOTERMINAL_METRIC_INTERVAL_SECONDS:-900}"
MIN_GAP_MINUTES="${LOWCAP_GECKOTERMINAL_METRIC_MIN_GAP_MINUTES:-10}"
LIMIT="${LOWCAP_GECKOTERMINAL_METRIC_LIMIT:-10}"
...
START_DELAY_SECONDS="${LOWCAP_GECKOTERMINAL_METRIC_START_DELAY_SECONDS:-120}"
