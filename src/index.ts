const lines = [
  ...
  "  Dry-run by default; fetch GeckoTerminal token snapshots for recent Gecko-origin tokens, preview enrich plus rescore, and write both stages only with --write.",
  "  Example: pnpm token:enrich-rescore:geckoterminal -- --limit 10 --sinceMinutes 180 --write",
  "",
