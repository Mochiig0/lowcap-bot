const lines = [
  ...
  "  Fetch one live GeckoTerminal Solana new_pools item, build one source_event_hint candidate, and print dry-run evaluation JSON.",
  "  Example: pnpm detect:geckoterminal:new-pools",
  "",
