const lines = [
  ...
  "  Fetch one GeckoTerminal Solana new_pools item, build one source_event_hint candidate, and stay dry-run unless --write hands one accepted mint into import:mint.",
  "  Example: pnpm detect:geckoterminal:new-pools -- --file ./fixtures/source-events/geckoterminal-new-pools.solana-wtf-first-item.json --write",
  "",
