const lines = [
  ...
  "  Read-only GeckoTerminal operations summary for recent Gecko-origin tokens, including enrich coverage, metric coverage, score ranks, and a small recent preview.",
  "  Example: pnpm ops:summary:geckoterminal -- --sinceHours 24 --limit 10",
  "",
  "pnpm review:queue:geckoterminal -- [--sinceHours <N>] [--limit <N>]",
  "  Read-only GeckoTerminal review queue for recent Gecko-origin tokens, grouped by enrich, rescore, metric, notify, and stale-review categories.",
  "  Example: pnpm review:queue:geckoterminal -- --sinceHours 24 --limit 10",
  "",
