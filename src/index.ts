const lines = [
  ...
  "  Dry-run by default; fetch GeckoTerminal token snapshots for recent Gecko-origin tokens, preview enrich plus rescore, write both stages only with --write, and notify only with --write --notify when a token newly enters S-rank without hard reject.",
