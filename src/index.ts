const lines = [
  ...
  "  Read-only GeckoTerminal helper for SMOKE-excluded recent pending rows, with lightweight metadataStatus, selectionAnchorKind, reviewFlagsCount, and queuesMatched pattern summaries.",
  "  Example: pnpm review:pending-shape:geckoterminal -- --sinceHours 24 --limit 10",
  "",
