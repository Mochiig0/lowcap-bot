const lines = [
  ...
  "  Dry-run by default; with --watch --write, repeat GeckoTerminal new_pools cycles, persist a simple checkpoint cursor, retry one fetch-only 429 once after a short backoff, add extra cooldown only after 429 or timeout-like failed cycles, and continue after cycle-level errors.",
