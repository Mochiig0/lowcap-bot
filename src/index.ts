const lines = [
  ...
  "  Dry-run by default; with --watch, repeat snapshot cycles, continue after cycle-level errors, optionally narrow batch mode to mint strings ending with pump via --pumpOnly, optionally skip recent token+source metrics with --minGapMinutes, and stop the current cycle early after the first 429 token snapshot error.",
  "  Example: pnpm metric:snapshot:geckoterminal -- --limit 5 --sinceMinutes 120 --pumpOnly --watch --intervalSeconds 60 --minGapMinutes 10",
  "",
