...
- A third bounded detect watch write, run as a bounded operation MVP rehearsal,
  ...
  did not send Telegram; rawJson-free two-Metric report confirmation is the
  next gate.
