...
- A third bounded detect watch write, run as a bounded operation MVP rehearsal,
  ...
  send Telegram. The next gate for this mint is rawJson-free report
  confirmation.
