...
- `metrics:report` supports `mint`, `tokenId`, `source`, `rank`, `hasPeakFdv24h`, `hasMaxMultiple15m`, `hasTimeToPeakMinutes`, `sortBy`, and `sortOrder`; `null` sort targets are placed last
